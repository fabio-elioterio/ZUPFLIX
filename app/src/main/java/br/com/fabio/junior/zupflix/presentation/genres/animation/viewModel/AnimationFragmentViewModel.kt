package br.com.fabio.junior.zupflix.presentation.genres.animation.viewModel
    ...
    fun getMovieByGenre(apiKey: String, language: String, includeAdult: Boolean, withGenres: Int) {
        ...
        repository.getMoviesByGenres(apiKey, language, includeAdult, withGenres).enqueue(object :
            ...
            override fun onFailure(call: Call<GenresResponse>, t: Throwable) {
                Log.d(AnimationFragmentViewModel::class.java.simpleName, "ERROR ${t.message}")
            }
        })
    }
}